              ...
              >
                ...
                <div className="pt-3 border-t border-slate-100 space-y-2">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5">
                    ...
                    <button
                      onClick={() => onOpenProject(project, 'quotation')}
                      className="inline-flex items-center justify-center gap-1 py-2 px-1.5 bg-slate-100 hover:bg-amber-50 hover:text-amber-700 text-slate-700 rounded-lg text-[11px] font-semibold transition-colors"
                      title="View Financial Expenses Quotation"
                    >
